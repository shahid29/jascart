...
class Brand{
	...
	public function brandInsert($brandName){
		...
		if (empty($brandName)) {
			...
			if ($brandInsert) {
				$msg="<span class='success'>Brand Name Inserted Successfuly</span>";
				return $msg;
			}else{
	...
	public function brandUpdate($brandName, $id){
		...
		if (empty($brandName)) {
			...
			if ($updated_row) {
				$msg="<span class='success'>Brand Updated Successfuly</span>";
				return $msg;
	...
	public function delBrandById($id){
		...
		if ($deldata) {
			$msg="<span class='success'>Brand Name Deleted Successfuly</span>";
				return $msg;
		}else{
