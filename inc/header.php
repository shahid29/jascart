...
<body>
  <div class="wrap">
    ...
    ?>
				...
				<a href="index.php"><img width="213px" src="admin/<?php echo $result['logo'];?>" alt="" /></a>
	...
	?>		      
		...
		<div class="login">
			<?php 
				...
				<?php  }else{  ?> 
						<a style="font-size:18px" href="?cid=<?php Session::get('cmrId')?>">Logout </a>
			  <?php 	}
			?>  
...
<?php 
	...
	<?php
				...
				$getComparePro= $pd->getCompareProduct($cmrId);
				if ($getComparePro) {
				$i=0;
			?>
...
<?php
				...
				$checkWishList= $pd->getWishListData($cmrId);
				if ($checkWishList) {
				$i=0;
					?>
